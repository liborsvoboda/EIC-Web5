...
/***/ (function(module, exports, __webpack_require__) {
	...
	document.querySelector('#confirmBtn').addEventListener('click', function () {
	    _weui2.default.confirm('自定义内容的confirm', function () {
	        console.log('yes');
	    }, function () {
	        console.log('no');
	    });
...
/***/ (function(module, exports) {
	...
	module.exports = "<div class=\"<%= className %>\" role=alert> <div class=weui-mask_transparent></div> <div class=\"weui-toast <%= extClass %>\"> <i class=\"weui-icon_toast weui-icon-success-no-circle\"></i> <p class=weui-toast__content><%=content%></p> </div> </div> ";
