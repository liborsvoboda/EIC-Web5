...
var emmetSnippetField = function (index, placeholder) { return "${" + index + (placeholder ? ':' + placeholder : '') + "}"; };
...
function isValidLocationForEmmetAbbreviation(model, position, syntax, language) {
    ...
    var _a = model._tokenization, _tokenizationSupport = _a._tokenizationSupport, _tokenizationStateStore = _a._tokenizationStateStore;
